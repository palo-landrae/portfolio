    ...
    <div className="flex justify-center items-center py-8">
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {projects.map((project) => {
          return (
            <div className="rounded" key={project._id}>
              <div className="max-w-xs rounded overflow-hidden shadow-lg my-2 mx-3">
                <Image width="400" height="300" src="https://tailwindcss.com/img/card-top.jpg" alt="Sunset in the mountains" />
                ...
                <div className="flex flex-row w-full justify-end px-2">
                  <a target="_blank" href={project.demo} rel="noopener noreferrer">
                    <button className="my-4 mx-1 h-10 w-20 focus:ring-2 focus:ring-offset-2 rounded-md focus:ring-indigo-600 transition duration-150 ease-in-out hover:bg-indigo-600 focus:outline-none bg-indigo-700 rounded-r text-white px-5 text-sm">
                      Demo
                    </button>
                  </a>
